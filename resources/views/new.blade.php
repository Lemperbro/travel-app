...
<div id="photo" class="flex flex-col items-center justify-center min-h-screen font-mono">
            ...
            <div class="grid grid-cols-4">
                ...
                <div class="text-xl">
                    ...
                    <div class="">
                        ...
                        <h1 class="text-gray-900 dark:text-white font-semibold text-base">Extra:</h1>
                          <ul class="gap-4">

                            @foreach ($extra as $extras)
                            <li class="text-base">{{ $extras->judul }}</li>
                            @endforeach
                          </ul>
                        </div>
                        @else
...
<button onclick="screenshot()">poto</button>
