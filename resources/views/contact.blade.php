...
@section('container')
    ...
    <section class="bg-white dark:bg-gray-900 mx-auto">
      <div class="py-20 lg:py-32 px-4 mx-auto max-w-screen-md ">
        ...
        <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-green-50 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-8 w-8 dark:bg-gray-800 dark:text-green-400 dark:hover:bg-gray-700" data-dismiss-target="#alert-3" aria-label="Close">
          ...
          <form action="/contacts" method="post" class="space-y-8">
            ...
            <div>
              ...
              <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg sm:w-fit hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800 bg-orange-600">Send message</button>
          </form>
