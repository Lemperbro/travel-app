...
<section class="bg-white dark:bg-gray-900 ">
    <div class="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
        <div class="wf-ull lg:w-1/2">
            @if ($error == 404) 
            <p class="text-sm font-medium text-blue-500 dark:text-blue-400">{{ $error }} Error</p>
            ...
            <p class="mt-4 text-gray-500 dark:text-gray-400">You do not have permission to view this resource</p>
            @endif
        ...
        <div class="relative w-full mt-12 lg:w-1/2 lg:mt-0">
            @if ($error == 404)
            <img class="w-full max-w-lg lg:mx-auto" src="{{ asset('img/404.jpg') }}" alt="">
            @elseif ($error == 500)
            <img class="w-full max-w-lg lg:mx-auto" src="{{ asset('img/500.jpg') }}" alt="">
            @endif
        </div>
    </div>
</section>
