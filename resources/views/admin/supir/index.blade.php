                                    ...
                                    <tr
                                        ...
                                        <td class="px-4 py-10 text-sm text-center flex gap-x-4 justify-center">
                                            ...
                                            <button type="button" class="bg-red-600 p-2 rounded-md text-white"
                                                data-bs-toggle="modal"
                                                data-bs-target="#staticBackdrop-{{ $user->id }}">Hapus</button>
                                        </td>
            ...
            <div class="modal-dialog relative w-auto pointer-events-none">
                <div
                    ...
                    <div
                        ...
                        <form action="/admin/supir/edit/{{ $edit->id }}" method="POST" class="w-full px-4"
                            ...
                            <div class="mt-4">
                                ...
                                <input type="text" name="nama" id="nama"
                                    class="dark:bg-gray-600 dark:text-white font-semibold  w-full h-12 rounded-md p-2 border mt-4"
                                    value="{{ $edit->nama }}">
                            </div>
                            <div class="mt-4">
                                <label for="no_tlpn" class="dark:text-white">Telephone</label>
                                <input type="number" name="no_tlpn" id="no_tlpn" min="11"
                                    class="dark:bg-gray-600 dark:text-white font-semibold w-full h-12 rounded-md p-2 border mt-4"
                                    value="{{ $edit->no_tlpn }}">
                            </div>
                            <div class="mt-4">
            ...
            <div class="modal-dialog relative w-auto pointer-events-none">
                <div
                    ...
                    <div class="modal-body relative p-4">
                        {{-- isi model --}}
                        <form action="/supir/delete/{{ $delete->id }}" method="POST">
                            @csrf
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400 text-center">Are you sure
                                you want to Delete this Driver?</h3>
