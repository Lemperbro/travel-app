    ...
    <div class="mx-auto p-2">
      ...
      <div class="flex flex-wrap flex-row">
        <div class="flex-shrink max-w-full px-4 w-full">   
          <p class="text-xl font-bold mt-3 mb-5 dark:text-white">Unit Control</p>
        </div>                                                 
                    ...
                    <table class="table-sorter table-bordered w-full text-gray-600 dark:text-gray-400">
                      <thead>
                        <tr class="bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40">
                          ...
                          <th data-sortable="false">Number Plate</th>
                          <th class="hidden sm:table-cell">Destination</th>
                          <th class="text-center hidden lg:table-cell">Long Tour</th>
                        ...
                        <tr>
                          ...
                          <td>
                              <div class="flex justify-center mt-3 gap-x-6">
                                <div class="dark:text-gray-300 flex -center ">  
                                  Ari Budin
                                </div>
                              </div>
                          </td>
