...
@section('container')
    ...
    <div>
        ...
        <form method="post" action="/admin/wisata/add" enctype="multipart/form-data"
            ...
            @csrf
            <div x-ref="Content" class=" bg-white dark:bg-gray-700 md:rounded-lg px-4 py-8 md:p-20  overflow-auto">
                ...
                <div x-show="slide == 1">
                    ...
                    <div class="mb-5 text-center">
                        ...
                        <div class="mx-auto w-48 text-gray-500 dark:text-gray-200 text-xs text-center mt-1">Click to add
                            profile picture</div>

                        <input type="file" name="image[]" id="image"
                            class="w-full  hidden border object-cover rounded-md mt-4" multiple onchange="loadFile(event)">
                    </div>
                    ...
                    <div class="mt-10 mb-10">
                        ...
                        <textarea type="text" name="deskripsi" id="deskripsi"
                            class="w-full px-4 py-3 rounded-lg border-none  font-medium bg-gray-200 dark:bg-gray-900 text-gray-900 dark:text-white h-36"></textarea>
                    </div>
                ...
                <div x-show="slide == 2">
                    ...
                    <div class="mb-5">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-2">Note: please use <span class="font-bold">|</span>
                            to move bar</p>
                        <div class="flex flex-wrap gap-4">
                            <div id="inclusion" class="w-full">
                                ...
                                <textarea name="inclusion" id="inclusion"
                                    class="w-full rounded-md p-2 bg-gray-200 dark:bg-gray-900 border-none text-gray-900 dark:text-white h-32"></textarea>
                ...
                <div x-show="slide == 3">
                    ...
                    <div class="mb-5 mt-8">
                        ...
                        <div class="mb-5" id="day">
                            ...
                            <div id="itenerary" class="border-b-[1px] pb-4">

                                <input type="text" name="agenda[]" id="agenda"
                                    class="w-full h-12 rounded-md p-2 mt-4 mb-2 bg-gray-200 dark:bg-gray-900 border-none text-gray-900 dark:text-white">
                                <div class="grid lg:grid-cols-2 gap-x-4">
                                    <div class="w-full">
                                        <h1 class="text-gray-900 dark:text-white my-2">Start Time</h1>
                                        <input type="time" name="startTime[]"
                                            class="bg-gray-200 border-none dark:bg-gray-900 border border-gray-700 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white appearance-none w-full">
                                    </div>
                                    <div class="w-full">
                                        <h1 class="text-gray-900 dark:text-white my-2">End Time</h1>
                                        <input type="time" name="endTime[]"
                                            class="bg-gray-200 border-none dark:bg-gray-900 border border-gray-700 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white appearance-none w-full">
                                    </div>
                                </div>
                                <p class="text-gray-600 dark:text-gray-300 my-2">Note: please<span class="font-bold">
                                        Enter </span> to move bar</p>
                                <textarea id="banner-message"
                                    class="message w-full  h-20 relative text-gray-900 dark:text-white bg-gray-200 dark:bg-gray-900 border-none"
                                    name="itenerary[]" style="">
                            </textarea>
                    ...
                    <h1 id="add_day"
                        class="bg-blue-600 py-2 px-4 text-xl font-semibold text-white mt-4 rounded-md inline-block cursor-pointer float-left">
                        Add Day</h1>
