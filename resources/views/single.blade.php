...
<div class='relative'>
  ...
  <h1 class='absolute top-40 text-center text-white left-[50%] -translate-x-[50%] text-3xl font-bold'>Single Trip</h1>
  </div>
  <div class='container'>
      <div class='mt-12'>
      <h1 class='text-2xl text-black font-semibold z-10 text-center'>EXPLORE INDONESIA  WITH  GROWIN TRAVEL INDONESIA</h1>
      </div>
      <div class='mt-9'>
      ...
      <div class='mt-12 mb-14 grid grid-cols-3 grid-rows-2 gap-6'>
        ...
        <div class='border border-black'>
          <div class='flex'>
            <img src='/gambar/2.png' class="rounded-br-3xl rounded-bl-3xl"/>
          </div>
