...
<div class="backdrop-blur-[2px] absolute inset-0 -z-10"></div>
    ...
    <form method="post" action="{{ route('password.update') }}" class='w-[50%] mx-auto  mt-48 py-10 bg-white rounded-lg'>
      @csrf
      <img src="/gambar/logo.png" class='w-48 mx-auto mb-4' />



      <h1 class='text-4xl font-bold text-center mt-4 mb-8'>Reset Your Password</h1>
