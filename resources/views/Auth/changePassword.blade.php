                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                            ...
                            <div class="relative">
                                <div>
                                    ...
                                    <input type="password" name="current_password" id="password"
                                        class="w-full h-10 rounded-md mt-2  @error('current_password') peer @enderror"
                                        value="{{ old('current_password') }}" placeholder="Current Password">
                                ...
                                <div class="absolute right-5 top-1" onclick="ShowPassword()">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" id="eyeShow" height="48"
                                        viewBox="0 96 960 960" width="48" class="w-7">
                                        <path
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960"
                                        width="48" class="w-7 hidden" id="eyeHidden">
                                        <path
                        ...
                        <div>
                            ...
                            <input type="password" name="password"
                                class="w-full h-10 rounded-md mt-2  @error('password') peer @enderror"
                        ...
                        <div>
                            ...
                            <input type="password" name="password_confirmation"
                                class="w-full h-10 rounded-md mt-2 @error('password') peer @enderror" placeholder="Password Confrmation">
                            @error('password')
                                <p class="peer-invalid:visible text-red-700 font-light">
                                    {{ $message }}
                                </p>
