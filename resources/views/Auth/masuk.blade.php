...
@section('container')
    <img src="{{ asset('img/bg-login.jpg') }}" alt="" class="absolute inset-0 -z-20 h-screen w-full object-cover ">
    <div class="backdrop-blur-[2px] absolute inset-0 -z-10"></div>

    <form method="post" action="/login" class='w-[95%] md:w-[80%] lg:w-[60%] xl:w-[50%] mx-auto  mt-48 py-10 bg-white rounded-lg'>
        @csrf
        <img src="/gambar/logo.png" class='w-32 md:w-48 mx-auto mb-4' />



        <h1 class='text-2xl md:text-3xl xl:text-4xl font-bold text-center mt-4 mb-8'>Sign in to your account</h1>

        <div class='mx-4 lg:mx-9'>

            @if (session()->has('success'))
                <div class="alert bg-green-400 rounded-lg py-5 px-6 mb-8 text-base text-white inline-flex items-center w-full alert-dismissible fade show "
                    role="alert">
            ...
            <div class="w-full mt-8 ">
                ...
                <div class="relative flex ">
                    <input type="password" name="password" id="password" placeholder="Password"
                        class="password w-full h-10 rounded-md mt-2">

                    <div class="absolute right-5 top-1 justify-end" onclick="ShowPassword()">


                        <svg xmlns="http://www.w3.org/2000/svg" id="eyeShow" height="48" viewBox="0 96 960 960"
                            width="48 eyeShow" class="w-7">
                            <path
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"
                            class="w-7 hidden eyeHidden" id="eyeHidden">
                            <path
            ...
            <div class="flex justify-center my-7">
                <button type="submit"
                    class=" w-full inline-block px-6 py-2.5 bg-red-600 text-white font-bold text-lg leading-tight rounded-md shadow-md focus:shadow-lg focus:outline-none focus:ring-0  transition duration-150">Login</button>
            </div>
            ...
            <div class="py-5 text-center">
                <p class="whitespace-nowrap text-gray-600">
                    ...
                    <a href="/register" class="underline-offset-4 font-semibold text-orange-600 underline">Sign up for
                        free.</a>
                </p>
            </div>
