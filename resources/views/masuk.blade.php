...
<div class="backdrop-blur-[2px] absolute inset-0 -z-10"></div>
    ...
    <form method="post" action="/login" class='w-[50%] mx-auto  mt-48 py-10 bg-white rounded-lg'>
      ...
      <div class="w-full mt-8 ">
        ...
        <a href="{{ route('password.request') }}" class='text-red-600'> forgot Password?</a>
          ...
          <div class="relative flex ">
            <input type="password" name="password" id="password" placeholder="Password" class="password w-full h-10 rounded-md mt-2">
      ...
      <div class="flex justify-center my-7">
        <button type="submit"  class="inline-block px-6 py-2.5 bg-red-600 text-white font-bold text-lg leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150">Masuk</button>
      </div>
