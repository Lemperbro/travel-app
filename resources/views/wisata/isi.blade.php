    ...
    <div class="flex justify-between mb-20 gap-x-10">
        ...
        <form action="/checkout/{{ $wisata->slug }}" method="POST" class="border w-[30%] h-full relative rounded-lg p-2">
            ...
            <div class="relative max-w-sm p-2">
                ...
                <input type="date" id="date" name="tanggal" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Select date" autocomplete="off"/>
