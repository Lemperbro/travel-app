...
@foreach ($data as $wisata)
    ...
    @section('container')
        ...
        <div class="flex gap-x-2 mt-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="w-3 fill-gray-600">
        ...
        <div class="mt-5 mb-7 grid grid-cols-4 place-items-center border-b-[1px] p-4 rounded-md">
            ...
            <div class="flex gap-0">
                <div class="w-10 mx-5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        class="fill-orange-500 w-12 h-12 " style="transform: ;msFilter:;">
            ...
            <div class="flex gap-0">
                <div class="w-10 mx-5 relative">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        class="absolute top-6 -right-4" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;">
                        <path
        ...
        <div class="flex justify-between mb-20 gap-x-10">
            ...
            <div class="border w-[30%] h-full relative rounded-lg">
                <p class="text-sm text-center p-2 font-bold">Enter Number of Participants </p>
                <div class="flex justify-between p-2">
                    <div class="">
                        <h1 for="first_name" class="block text-sm font-bold text-gray-900 dark:text-white">child Group
                        </h1>
                    ...
                    <div class="">
                        <input type="number" id="first_name"
                            class="my-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-12 h-8 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                </div>

                <div class="flex justify-between p-2">
                    <div class="">
                        <h1 for="first_name" class="block text-sm text-gray-900 font-bold">adult Group
                        </h1>
                        <span class="text-xs text-red-600">5-12 years old</span>
                    </div>
                ...
                <div class="relative max-w-sm p-2">
                  ...
                  <a href="/checkout/{{ $wisata->slug }}">
                    <button class='shadow-best m-2 px-2 py-2 rounded-xl bg-[#FD522C] text-white flex font-semibold mx-auto text-sm'>
                        Booking Now
                    </button>
                </a>
