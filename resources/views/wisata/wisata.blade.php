...
<div>
    ...
    <div>
        ...
        <div class="absolute border border-red-600 w-full top-0">
            <h1
                class='absolute top-48 text-center text-white left-[50%] -translate-x-[50%] text-2xl md:text-4xl font-bold w-full'>
                SELECT YOUR PREFERRED DESTINATION</h1>

            <div
                class="mx-auto mt-5 max-w-screen-md py-20 leading-6 absolute top-48 left-[50%] translate-x-[-50%] w-[80%] lg:w-[50%]">
