    ...
    <div class="bg-[#FF2E00]">
        <div class="flex">
            <div class="mx-16 p-8 text-center">
                <img src="/icons/trek.png" alt="" class="mx-auto w-32">
            <p class="text-black bg-white px-4 py-5 rounded-md text-2xl font-semibold">Items that need <br> to be brought</p>
            </div>
